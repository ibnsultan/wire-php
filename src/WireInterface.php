...
interface WireInterface
{
     ...
     *
    * @throws WireException     Throws exception if $channels is an array of size 101 or above or $socket_id is invalid
     ...
     * @param bool  $already_encoded [optional]
     *
    * @throws WireException     Throws exception if curl wasn't initialized correctly
     * @throws ApiErrorException Throws ApiErrorException if the Channels HTTP API responds with an error
     * @throws GuzzleException
     *
     */
    ...
    * @throws WireException     Throws exception if curl wasn't initialized correctly
     ...
     *
    * @throws WireException     If $channel is invalid or if curl wasn't initialized correctly
     * @throws ApiErrorException Throws ApiErrorException if the Channels HTTP API responds with an error
     * @throws GuzzleException
     *
     */
    ...
    * @throws WireException Throws exception if $channel is invalid or above or $socket_id is invalid
    ...
    /**
    * Verify that a webhook actually came from Wire, decrypts any
